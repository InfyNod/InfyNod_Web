...
export async function seedDatabase(db) {
  ...
  await db.collection('settings').insertOne({
    ...
    hero_heading: 'We build AI-powered digital products that',
    hero_highlight: 'move business forward',
    hero_subtext: 'AI solutions, intelligent automation, custom software, web and mobile apps \u2014 designed, built and scaled by an Indian team that treats your product like its own.',
    industries: ['FinTech', 'HealthTech', 'Logistics', 'E-Commerce', 'EdTech', 'SaaS', 'Manufacturing', 'Real Estate'],
    tech_stack: ['OpenAI', 'LangChain', 'Python', 'TensorFlow', 'Next.js', 'React', 'Node.js', 'TypeScript', 'MongoDB', 'React Native', 'Flutter', 'AWS'],
    stats: [
  ...
  await db.collection('services').insertMany([
    ...
    },
    {
      ...
      icon: 'globe', order: 3, active: true,
    ...
    },
    {
      ...
      icon: 'smartphone', order: 4, active: true,
    ...
    },
    {
      ...
      icon: 'cloud', order: 6, active: true,
    ...
    },
    {
      ...
      icon: 'sparkles', order: 1, active: true,
